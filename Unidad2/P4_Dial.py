...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # Área de los Signals
        self.dial_integrantes.setMinimum(1)
        self.dial_integrantes.setMaximum(len(self.datos_imagenes))
        self.dial_integrantes.setSingleStep(1)
        self.dial_integrantes.setValue(1)
        self.dial_integrantes.valueChanged.connect(self.cambia)


    # Área de los Slots
    def cambia(self):
        dataClave = self.dial_integrantes.value()
        print(dataClave)
